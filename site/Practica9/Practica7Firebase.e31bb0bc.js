...
function getEntries() {
  var el = document.getElementById('bdinfo');
  db.collection('usuarios').get().then(function (querySnapshot) {
    querySnapshot.forEach(function (doc) {
      var data = doc.data();
      el.innerHTML += "<b>Id:</b> ".concat(doc.id, " </br><b>Nombre:</b> ").concat(data.nombre, " </br><b>Apellidos:</b> ").concat(data.apellidos, " <br><b>Username:</b> ").concat(data.username, "</br></br>");
    });
  });
}
...
var sendData = document.getElementById('enviarDatos').addEventListener('click', addEntry);
var removeData = document.getElementById('borrarDatos').addEventListener('click', removeEntry);
getEntries();
...
//# sourceMappingURL=/Practica7Firebase.e31bb0bc.js.map